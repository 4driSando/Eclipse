...
public class App {
	...
	public static void main(String[] args) {
		...
		int edadGallego = 89;
		System.out.println("\nTARIFA");
		System.out.println("Carla paga " + Tarifa.calcularPrecioMensual(edadCarla) + " euros");
		System.out.println("Ruth paga " + Tarifa.calcularPrecioMensual(edadRuth) + " euros");
		System.out.println("El Gallego paga " + Tarifa.calcularPrecioMensual(edadGallego) + " euros");
